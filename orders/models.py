...
class Orders(models.Model):
    ...
    pj_leader = models.CharField('负责人',choices=WORKERS_NAMES,max_length=200)
    workload_allot = models.FloatField('比例',default=0.0)
    pj_participant1 = models.CharField('完成人员1',max_length=200,choices=WORKERS_NAMES, blank=True)
    workload_allot1 = models.FloatField('比例1',default=0.0)
    pj_participant2 = models.CharField('完成人员2',max_length=200, choices=WORKERS_NAMES,blank=True)
    workload_allot2= models.FloatField('比例2',default=0.0)
    pj_participant3 = models.CharField('完成人员3',max_length=200,choices=WORKERS_NAMES,blank=True)
