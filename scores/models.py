...
class Attitude(models.Model):
    ...
    at_liufeng = models.IntegerField('刘峰分数',choices= DEMOCRACY_LIST,default=DEMOCRACY_LIST[0][1])
...
class Responsibility(models.Model):
    ...
    re_liufeng = models.IntegerField('刘峰分数',choices= DEMOCRACY_LIST,default=DEMOCRACY_LIST[0][1])
...
class Discipline(models.Model):
    ...
    di_liufeng = models.IntegerField('刘峰分数',choices= DEMOCRACY_LIST,default=DEMOCRACY_LIST[0][1])
