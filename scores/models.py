...
class Attitude(models.Model):
    ...
    at_liufeng = models.IntegerField('许海鹏分数',choices= DEMOCRACY_LIST,default=DEMOCRACY_LIST[0][1])
    at_changxiaobo = models.IntegerField('常晓波分数',choices= DEMOCRACY_LIST,default=DEMOCRACY_LIST[0][1])
    ...
    at_liujiang = models.IntegerField('刘江分数',choices= DEMOCRACY_LIST,default=DEMOCRACY_LIST[0][1])
    ...
    at_yangxiao = models.IntegerField('杨晓分数',choices= DEMOCRACY_LIST,default=DEMOCRACY_LIST[0][1])
    at_liulei = models.IntegerField('刘雷分数',choices= DEMOCRACY_LIST,default=DEMOCRACY_LIST[0][1])
    at_huangqiangxu = models.IntegerField('黄锵栩分数',choices= DEMOCRACY_LIST,default=DEMOCRACY_LIST[0][1])
...
class Responsibility(models.Model):
    ...
    re_liufeng = models.IntegerField('许海鹏分数',choices= DEMOCRACY_LIST,default=DEMOCRACY_LIST[0][1])
    re_changxiaobo = models.IntegerField('常晓波分数',choices= DEMOCRACY_LIST,default=DEMOCRACY_LIST[0][1])
    ...
    re_liujiang = models.IntegerField('刘江分数',choices= DEMOCRACY_LIST,default=DEMOCRACY_LIST[0][1])
    ...
    re_yangxiao = models.IntegerField('杨晓分数',choices= DEMOCRACY_LIST,default=DEMOCRACY_LIST[0][1])
    re_liulei = models.IntegerField('刘雷分数',choices= DEMOCRACY_LIST,default=DEMOCRACY_LIST[0][1])
    re_huangqiangxu = models.IntegerField('黄锵栩分数',choices= DEMOCRACY_LIST,default=DEMOCRACY_LIST[0][1])
...
class Discipline(models.Model):
    ...
    di_liufeng = models.IntegerField('许海鹏分数',choices= DEMOCRACY_LIST,default=DEMOCRACY_LIST[0][1])
    di_changxiaobo = models.IntegerField('常晓波分数',choices= DEMOCRACY_LIST,default=DEMOCRACY_LIST[0][1])
    ...
    di_liujiang = models.IntegerField('刘江分数',choices= DEMOCRACY_LIST,default=DEMOCRACY_LIST[0][1])
    ...
    di_yangxiao = models.IntegerField('杨晓分数',choices= DEMOCRACY_LIST,default=DEMOCRACY_LIST[0][1])
    di_liulei = models.IntegerField('刘雷分数',choices= DEMOCRACY_LIST,default=DEMOCRACY_LIST[0][1])
    di_huangqiangxu = models.IntegerField('黄锵栩分数',choices= DEMOCRACY_LIST,default=DEMOCRACY_LIST[0][1])
